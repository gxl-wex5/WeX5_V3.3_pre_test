define(function(require){
	...
	if(Browser.isAndroid){
	    ...
	    $('<style type="text/css">.android_soft_input_cover_bug{z-index:10000 !important;position:fixed !important;width:100% !important;height:48px;left:0 !important;bottom:0 !important;margin:0 !important;}</style>').appendTo('body');
	            ...
	            if(activeElement && /^(INPUT|TEXTAREA)$/.test(activeElement.nodeName)){
	                if(!isInViewport(activeElement)){
                		...
                		if(activeElement.scrollIntoView){
                			...
                			$(activeElement).addClass('android_soft_input_cover_bug');
                		}
	                }
	            }
