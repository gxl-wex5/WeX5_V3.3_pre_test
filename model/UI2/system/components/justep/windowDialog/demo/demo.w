...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="position:absolute;;left:396.0px;top:562.0px" onLoad="modelLoad"> 
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content1"> 
      <span component="$UI/system/components/justep/windowDialog/windowDialog"
        xid="windowDialog" style="left:523px;top:120px;" src="$UI/system/components/justep/windowDialog/demo/dialog.w"
        routable="true" status="normal" showTitle="false" onReceive="windowDialogReceive"> 
   ...
   <mapping from="age" to="age" xid="default9"></mapping></result></span>  
      <div xid="dialog"/>  
