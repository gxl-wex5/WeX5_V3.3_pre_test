...
<span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver" onReceive="windowReceiverReceive"></span>
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter" xid="toolBar1"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="全选" xid="button1">
   <i xid="i1"></i>
   <span xid="span1">全选</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="全不选" xid="button2">
   <i xid="i2"></i>
 ...
 <div class="form-horizontal data-form  x-scroll-view" component="$UI/system/components/bootstrap/form/form" xid="form1">
  ...
  <div class="col col-xs-1 col-sm-1 col-md-1 col-lg-1" xid="col3"><span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="checkbox1" bind-ref='val("check")' name="checkbox"></span></div>
