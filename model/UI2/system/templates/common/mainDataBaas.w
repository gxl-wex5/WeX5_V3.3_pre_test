   ...
   <div class="x-edit" xid="controlGroupForm1"><input component="$UI/system/components/justep/input/input" class="form-control" xid="input5" bind-ref="filter"></input></div></div></div> 
      ...
      <div class="x-control-group" style="height:254px;"> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label25" xid="labelEdit1"> 
          ...
          <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input2" bind-ref="serviceURL" bind-disable="$model.type!=='service'" /> 
        </div>  
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label25" xid="labelEdit5"> 
          ...
          <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input6" bind-ref="table" bind-disable="$model.type!=='service'" />
        </div>
