define(function(require) {
	...
	require("w!/UI2/demo/account/classSetting.w");
	
	require("w!/UI2/demo/native/toast/index.w");
	require("w!/UI2/demo/native/calendar/index.w");
	require("w!/UI2/demo/native/actionsheet/index.w");
	require("w!/UI2/demo/native/screenorientation/index.w");
	...
	return {
		"$children" : [{
			"$children" : [{
				...
				"label" : "calendar",
				"psmCount" : "1",
				"url" : "/UI2/demo/native/calendar/index.w"
			}, {
				"$name" : "item",
				"$text" : "",
				"display" : "solid",
				"label" : "actionsheet",
				"psmCount" : "1",
				"url" : "/UI2/demo/native/actionsheet/index.w"
			}, {
				"$name" : "item",
				"$text" : "",
				"display" : "solid",
				...
				"psmCount" : "1",
				"url" : "/UI2/demo/native/screenorientation/index.w"
			}
			, {
				"$name" : "item",
				"$text" : "",
			...
			"$children" : [{
				...
				"label" : "记账本—设置分类",
				"psmCount" : "1",
				"url" : "/UI2/demo/account/classSetting.w"
			}, {
				"$name" : "item",
				"$text" : "",
				"display" : "solid",
