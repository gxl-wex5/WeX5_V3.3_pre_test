...
<h4 xid="h41"><![CDATA[自定义样式]]>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="查看JS" xid="js" onClick="jsClick">
   <i xid="i1"></i>
   <span xid="span1">查看JS</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="查看源码" xid="source" onClick="sourceClick">
   <i xid="i2"></i>
   <span xid="span2">查看源码</span></a></h4><div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="productGrid" data="productData" multiselect="true" showRowNumber="true" width="100%" onCellRender="productGridCellRender">
