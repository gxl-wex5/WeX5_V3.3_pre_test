...
<h4 xid="h41"><![CDATA[冻结列]]>
  ...
  <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="employeeGrid" data="employeeData" frozenColumnCount="1" height="auto" width="100%">
   <columns xid="columns1"><column name="name" xid="column1" width="400"></column>
  <column name="sex" xid="column2" width="400"></column>
  <column name="dept" xid="column3" width="400"></column>
  <column name="enducation" xid="column4" width="400"></column></columns></div></div>