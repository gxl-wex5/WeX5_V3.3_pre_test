...
<h4 xid="h41" class="center-block"><![CDATA[动态表格操作]]>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="source" onClick="sourceClick">
   ...
   <i xid="i3"></i>
   <span xid="span3">获得id为2的行的值</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="获得整个表格的值" xid="allGrid" onClick="allGridClick">
   <i xid="i4"></i>
   <span xid="span4">获得整个表格的值</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="删除选中行" xid="delete" onClick="deleteClick">
   <i xid="i5"></i>
   ...
   <i xid="i11"></i>
   <span xid="span11">下移行</span></a></div><div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="employeeGrid" data="employeeData" multiselect="true" showRowNumber="true" width="100%">
