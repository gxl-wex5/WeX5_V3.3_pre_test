define(function(require) {
	...
	Model.prototype.jsClick = function(event) {
		util.showSource({
			self : this,
			data : "demo/sample/grid/toolbarControl.js"
		});
	};
	//源码
	...
	Model.prototype.firstSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/toolbarControl.w&xid=firstToolBar"
		});
	};
	//源码
	Model.prototype.secondSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/toolbarControl.w&xid=secondToolBar"
		});
	};
	//源码
	Model.prototype.thirdSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/toolbarControl.w&xid=thirdToolBar"
		});
	};
