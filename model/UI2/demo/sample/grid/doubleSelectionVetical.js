define(function(require) {
	...
	Model.prototype.jsClick = function(event) {
		util.showSource({
			self : this,
			data : "demo/sample/grid/doubleSelectionVetical.js"
		});
	};
	//源码
	...
	Model.prototype.topSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/doubleSelectionVetical.w&xid=aboveGrid"
		});
	};
	//下表源码
	Model.prototype.bottomSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/doubleSelectionVetical.w&xid=bottomGrid"
		});
	};
