define(function(require) {
	...
	// 获得整个表格的值
	Model.prototype.allGridClick = function(event) {
		justep.Util.hint(JSON.stringify(this.comp('employeeData').toJson()));
	};
	// 删除选中行
	...
	Model.prototype.jsClick = function(event) {
		util.showSource({
			self : this,
			data : "demo/sample/grid/dynamicOperation.js"
		});
	};
	// 源码
	Model.prototype.sourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/dynamicOperation.w&xid=employeeGrid"
		});
	};
