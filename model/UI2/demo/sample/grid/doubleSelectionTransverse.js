define(function(require) {
	...
	Model.prototype.jsClick = function(event) {
		util.showSource({
			self : this,
			data : "demo/sample/grid/doubleSelectionTransverse.js"
		});
	};
	//左表源码
	Model.prototype.leftSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/doubleSelectionTransverse.w&xid=leftGrid"
		});
	};
	//右表源码
	Model.prototype.rightSourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/grid/doubleSelectionTransverse.w&xid=rightGrid"
		});
	};
