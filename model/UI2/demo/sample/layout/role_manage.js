define(function(require) {
	...
	Model.prototype.showJsSource = function(event){
		util.showSource({
			self : this,
			data : "demo/sample/layout/role_manage.js"
		});
	};
	...
	Model.prototype.showReleUsersSource = function(event){
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/layout/role_manage.w&xid=relevance_users"
		});
	};
	...
	Model.prototype.showResourceSource = function(event){
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/layout/role_manage.w&xid=resource"
		});
	};
	...
	Model.prototype.showSource = function(event){
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/layout/role_manage.w&xid=window"
		});
