...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:126px;top:318px;"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="textData" idColumn="fID" onCustomRefresh="textDataCustomRefresh"><column label="ID" name="fID" type="String" xid="xid2"></column>
...
<div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs">
   ...
   <i xid="i3"></i>
   <span xid="span4">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button4" bind-visible="isVisible" onClick="showTabsSource">
   <i xid="i4"></i>
   <span xid="span5">源码</span></a><div xid="div3" style="height:72px;width:200px;">
    ...
    <div class="tab-pane" xid="tabContentTwo">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link" xid="button5" label="页面源码" style="background-color:#61CD66;width:80px;" bind-visible="isVisible" onClick="showTabContentTwoSource">
   <i xid="i5"></i>
   <span xid="span6">页面源码</span></a><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" title="查询用户" xid="list">
  ...
  <div class="x-col x-col-fixed" xid="col7" style="width:auto;"><input component="$UI/system/components/justep/input/input" class="form-control" xid="input1"></input></div>
  <div class="x-col x-col-fixed" xid="col8" style="width:auto;"><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="查询" xid="button1" icon="icon-android-search" style="width:67px;background-color:#EEEEEE;">
