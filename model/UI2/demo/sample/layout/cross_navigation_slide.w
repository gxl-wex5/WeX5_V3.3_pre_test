...
<div component="$UI/system/components/justep/button/buttonGroup" class="btn-group" tabbed="true" xid="title" style="width:100%;height:34px;background-color:#F0F0F0;" selected="button1">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button7" onClick="showSource" bind-visible="isVisible">
   <i xid="i7"></i>
   <span xid="span12">源码</span></a></div>
  <hr xid="hr1" class="hr"></hr>
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents2" style="top:39px;" slidable="true">
