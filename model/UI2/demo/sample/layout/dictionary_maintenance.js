define(function(require){
	...
	Model.prototype.showjsSource = function(event){
		util.showSource({
			self : this,
			data : "demo/sample/layout/dictionary_maintenance.js"
		});
	};
	...
	Model.prototype.showSource = function(event){
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/layout/dictionary_maintenance.w&xid=window"
		});
	};
	...
	Model.prototype.showDataMaintenanceSource = function(event){
		util.showSource({
			self : this,
			type : true,
			data : "demo/sample/layout/dictionary_maintenance.w&xid=dataMaintenance"
		});
	};
