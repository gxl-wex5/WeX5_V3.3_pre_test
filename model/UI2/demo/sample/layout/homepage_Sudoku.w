...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="js" xid="button1" onClick="showjsSource">
   <i xid="i2"></i>
   <span xid="span3">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button2" bind-visible="isVisible" onClick="showPageSource">
   <i xid="i3"></i>
   <span xid="span4">源码</span></a><div component="$UI/system/components/justep/list/list" class="x-list" xid="list" data="sudokuData">
