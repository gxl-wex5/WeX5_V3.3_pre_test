...
<div component="$UI/system/components/justep/row/row" class="x-row" xid="row2" style="height:100%;">
   ...
   <div class="x-col" xid="col7" style="height:100%;"><div component="$UI/system/components/justep/contents/contents" class="x-contents " active="0" xid="contents1" style="width:100%;height:100%;">
   <div class="x-contents-content" xid="content1" style="white-space:nowrap;overflow:hidden;"><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" title="查询" xid="controlGroup1">
   ...
   <i xid="i8"></i>
   <span xid="span22">JS</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button7" bind-visible="isVisible" onClick="showSource">
   <i xid="i9"></i>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   ...
   <div class="x-col x-col-fixed x-col-center" xid="col3" style="width:auto;"><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="查询" xid="button1" icon="icon-android-search" style="background-color:#E6E6E6;">
   <i xid="i1" class="icon-android-search"></i>
   <span xid="span8">查询</span></a></div>
  <div class="x-col x-col-fixed x-col-center" xid="col4" style="width:auto;"><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="重置" xid="button2" icon="icon-laptop" style="background-color:#E6E6E6;">
