...
<div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="width:750px;">
  ...
  <span xid="span6" class="pull-left"><![CDATA[（用户数量大时使用这种方式）]]></span></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="width:750px;">
  ...
  <span xid="span1" class="pull-left"><![CDATA[（用户数量小时使用这种方式）]]></span></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4" style="width:750px;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="width:750px;">
   ...
   <a component="$UI/system/components/justep/button/button" class="btn2 btn btn-link" label="重置" xid="button4" style="width:70px;background-color:#D9D9D9;" onClick="clearClick">
    <i xid="i4"></i>
    <span xid="span5">重置</span></a> </div></div></div><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="JS" xid="button6" style="background-color:#ABCFA7;width:80px;" onClick="showJsSource">
   <i xid="i8"></i>
   <span xid="span22">JS</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button7" style="background-color:#61CD66;width:80px;" onClick="showSource" bind-visible="isVisible">
   <i xid="i9"></i>
