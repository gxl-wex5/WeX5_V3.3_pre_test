...
<a component="$UI/system/components/justep/button/button" class="btn btn-link" label="JS" xid="button6" onClick="showJsSource">
   <i xid="i8"></i>
   ...
   <i xid="i9"></i>
   <span xid="span23">源码</span></a><div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables" data="roleData" showRowNumber="true" onCellRender="dataTablesCellRender" onRowClick="dataTablesRowClick" ordering="false">
