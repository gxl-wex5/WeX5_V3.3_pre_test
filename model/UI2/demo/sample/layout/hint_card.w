...
<span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver1"></span><div xid="div1" style="height:320px;width:380px;" class="div"><div xid="div8" style="height:auto;width:110px;" class="pull-left div2">
  ...
  <div xid="div12" style="height:46px;width:214px;" class="pull-right div4">
   ...
   <a component="$UI/system/components/justep/button/button" class="btn1 btn btn-link" label="取消" xid="cancel" onClick="cancelClick">
    <i xid="i15"></i>
    <span xid="span15">取消</span></a> </div></div></div>