...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" 
  ...
  <div xid="main" style="width:100%;height:300px;white-space:nowrap;overflow:hidden;"></div><label xid="label1"><![CDATA[图表与表格结合]]></label><a component="$UI/system/components/justep/button/button" class="btn btn-link btn1" label="js" xid="button6" onClick="showJsSource">
   <i xid="i6"></i>
   ...
   <i xid="i7"></i>
   <span xid="span17">源码</span></a><div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables" data="textData" ordering="false" showRowNumber="true" style="width:100%;">
