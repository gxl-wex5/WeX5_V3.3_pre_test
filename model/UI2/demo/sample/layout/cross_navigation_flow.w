...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:126px;top:318px;"></div> 
  ...
  <hr xid="hr9" style="height:5px;width:17%;" class="pull-left hr"></hr></div></div>
   ...
   <div class="x-contents-content" xid="pageOne"><div xid="div17"><label xid="label1" class="label1"><![CDATA[流程导航是纯静态元素组成，相对于流程选项卡的优势在于有非常好的性能。]]></label></div><a component="$UI/system/components/justep/button/button" class="btn btn-link btn1" label="js" xid="button6" onClick="showJsSource">
   <i xid="i6"></i>
   <span xid="span11">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link btn1" label="源码" xid="button7" onClick="showSource" bind-visible="isVisible">
   <i xid="i7"></i>
   <span xid="span17">源码</span></a><div xid="div2" style="height:124px;width:139px;"><label xid="label2"><![CDATA[这是页面1]]></label></div><div xid="div3" style="height:124px;width:139px;">
  ...
  <div class="x-contents-content" xid="pageTwo"><label xid="label12" class="label1">流程导航是纯静态元素组成，相对于流程选项卡的优势在于有非常好的性能。</label>
  ...
  <div class="x-contents-content" xid="pageThree"><label xid="label19" class="label1">流程导航是纯静态元素组成，相对于流程选项卡的优势在于有非常好的性能。</label>
  ...
  <label xid="label15"><![CDATA[这是页面3]]></label></div>
  <div class="x-contents-content" xid="pageFour">
  
  
  <img src="$UI/demo/sample/layout/img/end.png" alt="" xid="image2" style="width:100%;" height="100%"></img></div></div></div>
   </div>
  </div>