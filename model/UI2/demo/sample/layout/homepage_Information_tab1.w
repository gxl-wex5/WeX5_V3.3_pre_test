...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents1">
   <div class="x-contents-content" xid="content1"><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-left" xid="controlGroup1" style="width:48%;height:250px;" title="个人信息">
   ...
   <span xid="span14"></span></a><span xid="span1"><![CDATA[]]></span></div> 
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="js" xid="button3" onClick="showjsSource">
   <i xid="i3"></i>
   <span xid="span3">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button8" bind-visible="isVisible" onClick="showPageSource">
   <i xid="i3"></i>
   <span xid="span2">源码</span></a></div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-right" title="信息接收" xid="controlGroup4" style="width:48%;height:250px;">
   ...
   <span xid="span7"></span></a><span xid="span4">title</span></div> 
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="informationData">
  ...
  </div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-left" title="工作日志" xid="controlGroup8" style="height:250px;width:48%;">
   ...
   <span xid="span22"></span></a><span xid="span16">title</span></div> 
    ...
    <li xid="li6">
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
      ...
      <div class="x-col x-col-fixed" xid="col8" style="width:auto;">
       <label xid="label8" bind-text="ref('fTime')">label</label></div> </div> </li> </ul> </div></div> </div></div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-right" title="通知公告" xid="controlGroup10" style="height:250px;width:48%;">
   <div class="x-control-group-title" xid="controlGroupTitle10" style="height:40px;">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="button" xid="button4" icon="icon-android-star" disabled="true">
    ...
    <li xid="li5">
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
      ...
      <div class="x-col x-col-fixed" xid="col7" style="width:auto;">
       <label xid="label5" bind-text="ref('fTime')">label</label></div> </div> </li> </ul> </div></div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-left" title="标准规范" xid="controlGroup11" style="height:250px;width:48%;">
   <div class="x-control-group-title" xid="controlGroupTitle12" style="height:40px;">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="button" xid="button6" icon="icon-android-calendar" disabled="true">
     ...
     <li xid="li7">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
       ...
       <div class="x-col x-col-fixed" xid="col10" style="width:auto;">
        <label xid="label9" bind-text="ref('fTime')">label</label></div> </div> </li> </ul> </div> </div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-right" title="内部审核" xid="controlGroup12" style="height:250px;width:48%;">
   <div class="x-control-group-title" xid="controlGroupTitle13" style="height:40px;">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="button" xid="button7" icon="icon-edit" disabled="true">
     ...
     <li xid="li8">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6">
       ...
       <div class="x-col x-col-fixed" xid="col12" style="width:auto;">
        <label xid="label10" bind-text="ref('fTime')">label</label></div> </div> </li> </ul> </div> </div></div></div></div>