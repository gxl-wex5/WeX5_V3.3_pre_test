...
<a component="$UI/system/components/justep/button/button" class="btn btn-link" label="打开用户信息" xid="open" onClick="{operation:'popOver1.show'}" style="background-color:rgb(245, 239, 239);">
   <i xid="i1"></i>
   <span xid="span1">打开用户信息</span></a>
  <div xid="div1" style="height:30px;" class="div1"><span xid="span2"><![CDATA[可用于首页弹出用户信息进行编辑。]]></span></div>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="js" xid="button1" onClick="showjsSource">
   <i xid="i2"></i>
   <span xid="span3">js</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button2" bind-visible="isVisible" onClick="showPageSource">
   <i xid="i3"></i>
   <span xid="span4">源码</span></a></div>