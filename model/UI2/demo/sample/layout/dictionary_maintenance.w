...
<div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" xid="controlGroup" title="字典列表">
   <div class="x-control-group-title" xid="controlGroupTitle1" style="height:45px;">
    <span xid="span1">title</span><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="js" xid="button9" onClick="showjsSource">
   <i xid="i9"></i>
   <span xid="span11">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button8" onClick="showSource" bind-visible="isVisible">
   <i xid="i8"></i>
