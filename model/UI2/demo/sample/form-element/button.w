...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
    ...
    <div class="x-contents-content" xid="content1">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-lg pull-right"
        ...
        <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form(bootstrap)"
          ...
          <div class="form-group" xid="formGroup3" style="width:auto;height:auto;"> 
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row2"> 
              <div class="col-sm-6" xid="col4" style="width:auto;height:auto;"></div>
            </div>
            <div component="$UI/system/components/justep/row/row" class="x-row"
              xid="row1"> 
              <div class="col-sm-6" xid="col5" style="width:auto;height:auto;"></div>
            </div> 
          </div> 
        </div>  
        <div component="$UI/system/components/bootstrap/row/row" class="row"
      ...
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form(bootstrap)"
          xid="div3"> 
          <div class="form-group" xid="formGroup4" style="width:auto;height:auto;"></div> 
        </div>  
        <div component="$UI/system/components/bootstrap/row/row" class="row"
          xid="row7"> 
