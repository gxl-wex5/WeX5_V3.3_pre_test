...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="multiLineData" idColumn="colorID"><column label="颜色ID" name="colorID" type="String" xid="xid5"></column>
  <data xid="default3">[{&quot;colorID&quot;:&quot;0&quot;}]</data></div></div>  
  <a component="$UI/system/components/justep/button/button" class="btn btn-link pull-right"
    ...
    <i xid="i5"/>  
    <span xid="span7">JavaScript</span>
  </a>
