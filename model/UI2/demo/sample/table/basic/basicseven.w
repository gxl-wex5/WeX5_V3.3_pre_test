...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    xid="dataTables" data="data" showRowNumber="false" multiSelect="false" onCellRender="dataTablesCellRender" onRowClick="dataTablesRowClick" rowActiveClass="blueActive"> 
    <columns xid="columns1">
      <column name="tID" xid="column4" visible="true" label=" "></column><column name="tName" xid="column1" label="姓名"/>  
      <column name="tSex" xid="column2" label="性别"/>  
      <column name="tAge" xid="column3" label="年龄"/>
    </columns>
  </div> 
<a component="$UI/system/components/justep/button/button" class="btn btn-link" label="获取选中ridio" xid="radioButton" onClick="radioButtonClick">
   <i xid="i1"></i>
   <span xid="span1">获取选中ridio</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link pull-right" label="javaScript" xid="showJSButton" onClick="showJSButtonClick">
   <i xid="i2"></i>
   <span xid="span2">javaScript</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link pull-right" label="源码" xid="button" bind-visible="isVisible">
   <i xid="i3"></i>
   <span xid="span3">源码</span></a></div>
