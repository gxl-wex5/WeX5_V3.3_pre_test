...
<div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" class="table table-hover table-striped" xid="dataTables" data="data" showRowNumber="false" multiSelect="true" onRowCheck="dataTablesRowCheck">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="获取选中项" xid="button" onClick="buttonOneClick">
   <i xid="i1"></i>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="sourceButton" bind-visible="isVisible">
   <i xid="i3"></i>
