...
<div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" rowActiveClass="blueActive" class="table table-hover table-striped" xid="dataTables" data="data" showRowNumber="false" multiSelect="false">
   <columns xid="columns1"><column name="tName" xid="column1" label="姓名"></column>
  <column name="tSex" xid="column2" label="性别"></column>
  <column name="tAge" xid="column3" label="年龄"></column></columns>
  
  </div>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="CSS" xid="showCSSButton" onClick="showCSSButtonClick">
   <i xid="i1"></i>
   <span xid="span1">CSS</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="button" bind-visible="isVisible">
   <i xid="i2"></i>
