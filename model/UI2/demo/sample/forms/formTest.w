...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:-1px;left:234px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="userData" idColumn="uName" confirmRefresh="false" onValueChange="dataValueChange" autoNew="false" onCustomSave="userDataCustomSave">
   <column label="用户名:" name="uName" type="String" xid="xid1"></column>
  <column label="姓名：" name="name" type="String" xid="xid2"></column>
  <column label="密码;" name="pass" type="String" xid="xid3"></column>
  <column label="确认密码：" name="truePwd" type="String" xid="xid4"></column>
  <column label="爱好：" name="Hobby" type="String" xid="xid5"></column>
  <column label="性别：" name="sex" type="String" xid="xid6"></column>
  <column label="年龄：" name="age" type="String" xid="xid7"></column>
  <column label="电子邮件：" name="email" type="String" xid="xid8"></column>
  <column label="手机号码：" name="tel" type="String" xid="xid9"></column>
  <column label="邮政编码:" name="postcode" type="String" xid="xid10"></column>
  <column label="QQ：" name="QQ" type="String" xid="xid11"></column>
  <column label="IP地址：" name="address" type="String" xid="xid12"></column>
  <column label="正负小数：" name="col12" type="String" xid="xid13"></column>
  <column label="正负整数与小数:" name="col13" type="String" xid="xid14"></column>
  <column label="单选下拉框：" name="radioSelect" type="String" xid="xid15"></column>
  <column label="提示下拉框：" name="hintSelect" type="String" xid="xid16"></column>
  <column label="数字进步器：" name="num" type="Integer" xid="xid19"></column>
  <column label="自动提示框：" name="col20" type="String" xid="xid27"></column>
  <column label="日期控件：" name="date" type="Date" xid="xid22"></column>
  <column label="双向选择器：" name="select" type="String" xid="xid17"></column>
  <column label="文本域：" name="desc" type="String" xid="xid26"></column>
  <rule xid="rule1">
   <col name="uName" xid="ruleCol1">
    <required xid="required1">
     <expr xid="default9">true</expr>
     <message xid="default11">用户名不能为空</message></required> 
    <constraint xid="constraint1">
     <expr xid="default10">/^\w{5,15}$/.test( $model.userData.val(&quot;uName&quot;))</expr>
     <message xid="default12">用户名格式不正确</message></constraint> </col> 
   <col name="name" xid="ruleCol2">
    <required xid="required2">
     <expr xid="default13">true</expr>
     <message xid="default14">姓名不能为空</message></required> </col> 
   ...
   <col name="truePwd" xid="ruleCol4">
    <required xid="required4">
     ...
     <expr xid="default24">true</expr></required> </col> 
   <col name="Hobby" xid="ruleCol5">
    <required xid="required5">
     <message xid="default17">爱好不能为空</message>
     <expr xid="default25">true</expr></required> </col> 
   <col name="sex" xid="ruleCol6">
    <required xid="required6">
     <message xid="default18">性别不能为空</message>
     <expr xid="default26">true</expr></required> </col> 
   <col name="age" xid="ruleCol7">
    <required xid="required7">
     <message xid="default19">年龄不能为空</message>
     <expr xid="default27">true</expr></required> </col> 
   <col name="email" xid="ruleCol8">
    <required xid="required8">
     <message xid="default20">邮箱不能为空</message>
     <expr xid="default28">true</expr></required> </col> 
   <col name="tel" xid="ruleCol9">
    <required xid="required9">
     <message xid="default21">用户名不能为空</message></required> </col> 
   <col name="postcode" xid="ruleCol10">
    <required xid="required10">
     <message xid="default22">用户名不能为空</message></required> </col> </rule>
  <data xid="default2">[{&quot;uName&quot;:&quot;&quot;,&quot;radioSelect&quot;:&quot;&quot;,&quot;hintSelect&quot;:&quot;&quot;,&quot;num&quot;:1}]</data></div><div component="$UI/system/components/justep/data/data" autoLoad="true"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default4">[{&quot;hobby&quot;:&quot;打羽毛球&quot;},{&quot;hobby&quot;:&quot;打篮球&quot;}]</data></div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="selectData" idColumn="address"> 
    ...
    </div><div component="$UI/system/components/justep/data/data" autoLoad="true"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        xid="titleBar1" title="表单验证"> 
        <div class="x-titlebar-title" xid="div2">表单验证</div>  
    ...
    <div class="x-panel-content" xid="content1" style="height:auto;"> 
      <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"
        xid="form1" style="width:auto;"> 
        <fieldset xid="fieldset1" class="css1"> 
          <legend xid="default1">基本使用</legend>  
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col13"> 
              ...
              <input component="$UI/system/components/justep/input/input" placeholder="请输入密码"
                class="form-control" type="password" xid="pass" bind-keyup="passKeyup" bind-ref="userData.ref('pass')"/> 
            </div>  
            ...
            <div class="x-col" xid="col10"> 
              ...
              <input component="$UI/system/components/justep/input/input" placeholder="再次输入密码"
                class="form-control"  type="password" xid="repass" bind-keyup="repassKeyup" bind-ref="userData.ref('truePwd')"/> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row4"> 
            ...
            <div class="x-col" xid="col14" bind-select="col14Select"> 
              <span component="$UI/system/components/justep/select/radioGroup"
                class="x-radio-group" xid="radioGroup" bind-itemsetValue="ref('sex')"
                bind-itemsetLabel="ref('sex')" bind-itemset="sexData" bind-ref="userData.ref('sex')" onChange="radioGroupChange"/>  
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col x-col-20" xid="col28"> 
              <label xid="label12" class="pull-right" placeholder="请输入正确的邮箱"
                bind-text="userData.label('QQ')">label</label> 
            </div>  
            <div class="x-col" xid="col29"> 
              <span xid="QQspan" class="spans">*</span>  
               
            <input component="$UI/system/components/justep/input/input" placeholder="请输入QQ号" class="form-control" xid="QQ" bind-keyup="QQKeyup" bind-ref="userData.ref('QQ')" /></div>  
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col30"> 
              ...
              <input component="$UI/system/components/justep/input/input" placeholder="请输入正负整数或小数"
                class="form-control" xid="integ" bind-ref="userData.ref('col13')"
                bind-keyup="integKeyup"/> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row9"> 
            <div class="x-col x-col-20" xid="col36">
   <label xid="label16" class="pull-right" bind-text="userData.label('radioSelect')">label</label></div><div class="x-col" xid="col37"> 
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col45"> 
              ...
              <input component="$UI/system/components/justep/input/input" class="form-control" xid="input15" bind-ref="userData.ref('num')" style="float: left;width:11%;"></input><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
            ...
            <div class="x-col" xid="col46"> 
              <span xid="datespan" class="spans">*</span><input component="$UI/system/components/justep/input/input" class="form-control"
                xid="date" dataType="Date" format="yyyy-MM-dd" bind-ref="userData.ref('date')" onChange="dateChange"/> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row14" style="height:300px;"> 
              ...
              <div component="$UI/system/components/justep/row/row" class="x-row"
                ...
                <div class="x-col x-col-10" xid="col6"> 
                  <div component="$UI/system/components/justep/button/buttonGroup"
                    class="btn-group btn-group-vertical" style="margin-top:80px;"
                    tabbed="全选" xid="buttonGroup1"> 
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col58"> 
              <textarea component="$UI/system/components/justep/textarea/textarea"
                class="form-control" xid="textarea1" style="height:100px;" bind-ref="userData.ref('desc')"/> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row17"> 
