...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link pull-right" label="JavaScript" xid="jsBtn" onClick="jsBtnClick">
   <i xid="i39"></i>
   <span xid="span54">JavaScript</span></a><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group"
    title="1、非iframe模式-基本使用" xid="controlGroup1"> 
      
    <div class="x-control-group-title" xid="controlGroupTitle1"> 
      <span xid="span1">title</span>
    </div><div xid="div3" style="height:200px;">
  ...
  <div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" title="16、tab过多左右滚动" xid="controlGroup16" style="height:344px;">
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-left" label="button" xid="scrollLeftBtn" icon="icon-chevron-left" onClick="scrollLeftBtnClick">
    <i xid="i33" class="icon-chevron-left"></i>
    <span xid="span53"></span></a> 
   <div xid="div8" name="aa" style="overflow:auto;overflow-x:hidden;white-space:nowrap;background-color:#fafafa;width:303px;height:35px;" class="pull-left">
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项7" xid="optionBtn7" target="optonContent7">
     <i xid="i12"></i>
     <span xid="span116">选项7</span></a> </div> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-left" label="button" xid="scrollRightBtn" icon="icon-chevron-right" onClick="scrollRightBtnClick">
    <i xid="i31" class="icon-chevron-right"></i>
    <span xid="span22"></span></a> 
   <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents1" style="height:206px;top:4700px">
    ...
    <div class="x-contents-content" xid="optonContent7">
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row88">
      <div class="x-col" xid="col85">
       <span xid="span26">内容7</span></div> </div> 
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row90">
      <div class="x-col" xid="col87">
       <span xid="span130">内容7</span></div> </div> </div> </div> </div><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" title="iframe模式" xid="controlGroup17" style="height:800px;">
   <div class="x-control-group-title" xid="controlGroupTitle20">
    <span xid="span28">title</span></div> 
   ...
   <div name="bb" xid="div2" style="overflow:auto;overflow-x:hidden;white-space:nowrap;background-color:#fafafa;width:300px;height:35px;" class="pull-left">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项1" xid="optionBtn8" target="optonContent8">
     <i xid="i17"></i>
     <span xid="span71">选项1</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项2" xid="optionBtn9" target="optonContent9">
     <i xid="i37"></i>
     <span xid="span71">选项2</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项3" xid="optionBtn10" target="optonContent10">
     <i xid="i36"></i>
     <span xid="span21">选项3</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项4" xid="optionBtn11" target="optonContent11">
     <i xid="i34"></i>
     <span xid="span24">选项4</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项5" xid="optionBtn12" target="optonContent12">
     <i xid="i38"></i>
     <span xid="span23">选项5</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项6" xid="optionBtn13" target="optonContent13">
     <i xid="i12"></i>
     <span xid="span27">选项6</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="选项7" xid="optionBtn14" target="optonContent14">
     <i xid="i12"></i>
     <span xid="span25">选项7</span></a></div> 
   ...
   <div component="$UI/system/components/justep/contents/contents" class="x-contents " active="0" xid="contents17" style="width:100%;height:100%;" slidable="true" wrap="true">
    <div class="x-contents-content" xid="optonContent8" style="height:100%;width:100%;">
     <iframe src="https://www.baidu.com" xid="iframe12" frameborder="0px" height="100%" width="100%"></iframe></div> 
    <div class="x-contents-content" xid="optonContent9" style="height:100%;width:100%;">
     <iframe src="https://www.baidu.com" xid="iframe1" frameborder="0px" width="100%" height="100%"></iframe></div> 
    ...
    <div class="x-contents-content" xid="optonContent14"></div></div> </div><div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
