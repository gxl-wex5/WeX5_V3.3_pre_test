            ...
            <span class="glyphicon glyphicon glyphicon-search form-control-feedback"
              aria-hidden="true"/> 
                ...
                <div class="x-titlebar-right reverse" xid="div3"> 
                  ...
                  <a> 
                    <img src="./img/icon24.png" alt="" xid="importantBtn" height="26px"
                      bind-click="importantBtnClick"/> 
                  </a> 
                </div> 
              </div> 
            </div>  
            <div class="x-panel-content" xid="content1"> 
              <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                ...
                <div class="x-panel-top" xid="navMenuTop">
                  <div component="$UI/system/components/justep/row/row" class="x-row x-nav" xid="row5">
   <div class="x-col" xid="col15"><div class="x-navbox"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group" tabbed="true" xid="buttonGroup2">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label active" label="头条" target="navContent1" xid="button24">
    <i xid="i33"></i>
    <span xid="span44">头条</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="娱乐" target="navContent2" xid="button22">
    <i xid="i34"></i>
    <span xid="span43">娱乐</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="热点" target="navContent3" xid="button20">
    <i xid="i32"></i>
    <span xid="span41">热点</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="体育" target="navContent4" xid="button21">
    <i xid="i30"></i>
    <span xid="span42">体育</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="昆明" target="navContent5" xid="button23">
    <i xid="i31"></i>
    <span xid="span25">昆明</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="财经" target="navContent6" xid="button25">
    <i xid="i21"></i>
    <span xid="span20">财经</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="科技" target="navContent7" xid="button26">
    <i xid="i28"></i>
    <span xid="span40">科技</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="图片" target="navContent8" xid="button27">
    <i xid="i29"></i>
    <span xid="span33">图片</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="跟贴" target="navContent9" xid="button28">
    <i xid="i20"></i>
    <span xid="span32">跟贴</span></a> </div></div>
  </div>
   <div class="x-col x-col-fixed" xid="col16"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right center-block navMoreBtn" label="button" xid="button19" icon="icon-ios7-arrow-down" onClick="{operation:'popOver.show'}">
   <i xid="i15" class="text-muted icon-ios7-arrow-down"></i>
   <span xid="span7"></span></a></div>
   </div></div>  
                <div class="x-panel-content" xid="content2">
                  <div component="$UI/system/components/justep/contents/contents"
                    class="x-contents x-full" active="0" xid="navContents" wrap="false" onActiveChange="navContentsActiveChange"> 
                    ...
                    <div class="x-contents-content" xid="navContent2"> 
                      <div component="$UI/system/components/justep/windowContainer/windowContainer"
                        ...
                        src="./index_main2.w" autoLoad="false"/> 
                    </div>  
        ...
        <div class="x-contents-content" xid="readContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            ...
            src="./index-read.w" autoLoad="true"/> 
        </div>  
        <div class="x-contents-content" xid="audioContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="audioContainer" src="./index-audio.w"
            autoLoad="true"/> 
        </div>  
        <div class="x-contents-content" xid="foundContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="foundContainer" src="./index-found.w"
            autoLoad="true"/> 
        </div>  
        <div class="x-contents-content" xid="userContent"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="userContainer" src="./index-user.w" autoLoad="true"/> 
        </div> 
      </div> 
    </div>  
