                ...
                <tr xid="tr2" class="text-center"> 
                  <td xid="td1"> 
                    <a><img alt="" xid="image37"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_group.png')"/></a> 
                    <div xid="div32" bind-text="'跟团游'" class="h6">跟团游</div>
                  </td>  
                  <td xid="td2"> 
                    <a><img alt=""
                      xid="image33" class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_self_service.png')"/></a>  
                    <div xid="div33" bind-text="'自助游'" class="h6">自助游</div>
                  </td>  
                  <td xid="td3"> 
                    <a><img alt="" xid="image34"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_ship.png')"/></a>  
                    <div xid="div31" bind-text="'游轮'" class="h6">游轮</div>
                  </td>  
                  <td xid="td4"> 
                    <a><img alt="" xid="image35"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_drive.png')"/></a>  
                    <div xid="div37" bind-text="'自驾游'" class="h6">自驾游</div>
                  </td>  
                  <td xid="td5"> 
                    <a><img alt="" xid="image36"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_ticket.png')"/></a>  
                ...
                <tr xid="tr3" class="text-center"> 
                  <td xid="td8"> 
                    <a><img alt="" xid="image42"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_visa.png')"/></a>  
                    <div xid="div44" bind-text="'签证'" class="h6">签证</div>
                  </td>  
                  <td xid="td9"> 
                    <a><img alt="" xid="image41"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_hotel.png')"/></a>  
                    <div xid="div40" bind-text="'酒店'" class="h6">酒店</div>
                  </td>  
                  <td xid="td10"> 
                    <a><img alt="" xid="image39"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_plane.png')"/></a>  
                    <div xid="div45" bind-text="'机票'" class="h6">机票</div>
                  </td>  
                  <td xid="td11"> 
                    <a><img alt="" xid="image43"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_train.png')"/></a>  
                    <div xid="div42" bind-text="'火车票'" class="h6">火车票</div>
                  </td>  
                  <td xid="td12"> 
                    <a><img alt="" xid="image40"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_hotspot.png')"/></a>  
                ...
                <tr xid="tr5"> 
                  <td xid="td13"> 
                    <a><img alt="" xid="image44"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity1.jpg')"/></a>
                  </td>  
                  <td xid="td14"> 
                    <a><img alt="" xid="image45"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity2.jpg')"/></a>
                  </td>  
                  <td xid="td15"> 
                    <a><img alt="" xid="image46"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity3.jpg')"/></a>
                  </td> 
                </tr>  
                <tr xid="tr6"> 
                  <td xid="td17"> 
                    <a><img alt="" xid="image49"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity4.jpg')"/></a>
                  </td>  
                  <td xid="td18"> 
                    <a><img alt="" xid="image47"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity5.jpg')"/></a>
                  </td>  
                  <td xid="td19"> 
                    <a><img alt="" xid="image48"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity6.jpg')"/></a>
                  </td> 
                </tr> 
              </tbody> 
            </table> 
                ...
                <tr xid="tr4"> 
                  <td xid="td6"> 
                    <a><img alt="" xid="image22"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a1.jpg')"/></a> 
                  ...
                  <td xid="td7"> 
                    <a><img alt="" xid="image23"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a2.jpg')"/></a>
                  ...
                  <td xid="td16"> 
                    <a><img alt="" xid="image24"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a3.jpg')"/></a>  
                ...
                <tr xid="tr7"> 
                  <td xid="td20"> 
                    <a><img alt="" xid="image25"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a4.jpg')"/></a>  
                  ...
                  <td xid="td21"> 
                    <a><img alt="" xid="image26"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a5.jpg')"/></a>  
                  ...
                  <td xid="td22"> 
                    <a><img alt="" xid="image27"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a6.jpg')"/></a>  
