          ...
          <div class="container"> 
            <div component="$UI/system/components/bootstrap/row/row" class="row grid9"
              ...
              <div class="col cell col-xs-6 col-sm-4 col-md-4 col-lg-3" xid="col3"> 
                <div class="card"> 
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-link btn-icon-top" label="WeX5三大核心技术之xid技术" xid="button5"
                    ...
                    <span xid="span16">WeX5三大核心技术之xid技术</span> 
                  </a>
                </div> 
              </div>  
              <div class="col cell col-xs-6 col-sm-4 col-md-4 col-lg-3" xid="col31"> 
                <div class="card"> 
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-link btn-icon-top" label="WeX5三大核心技术之css局部化" xid="button51"
                    ...
                    <span xid="span161">WeX5三大核心技术之css局部化</span> 
                  </a>
                </div> 
              </div>  
              <div class="col cell col-xs-6 col-sm-4 col-md-4 col-lg-3" xid="col32"> 
                <div class="card"> 
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-link btn-icon-top" label="WeX5三大核心技术之js模块化" xid="button52"
                    ...
                    <span xid="span162">WeX5三大核心技术之css局部化</span> 
                  </a>
                </div> 
              </div>  
