            ...
            Thread t = new Thread(new Runnable() {
                public void run() {
                    try {
	                        ...
	                        public void run() {
	                        	appView.loadUrl("javascript:" +
	                        			"if (document.readyState == \"complete\") {" +
	                        				"setTimeout(function(){window._cordovaDetect.setExist(window.cordova?true:false);},2000);" +
	                        			"}else{" +
                        ...
                        cordova.getActivity().runOnUiThread(new Runnable() {
                            public void run() {
                                appView.loadUrl("javascript:window._cordovaDetect.setExist(window.cordova?true:false)");
                            }
                        });*/
                    } catch (Exception e) {
                    }
